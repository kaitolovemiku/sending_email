                                              ...
                                              <tbody>
                                                <tr>
                                                  <td valign="top" align="center" class="specbundle">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                      <div class="contentEditable">
                                                        <!-- <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1">Email Sending System - MFU&nbsp;</span></span></p> -->
                                                      </div>
                                                    </div>
                                                  </td>
                                                  <td valign="top" class="specbundle">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                      <div class="contentEditable">
                                                        <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#DC2828;'><span class="font">IT Staff Appointment System - MFU</span> </p>
                                                        <br>
                                                        <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1">{{$data->subject}}</span> </p>
                                                      </div>
                                                    </div>
                                                  </td>
                                                </tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <td align='left' style='color:#222222;'>
                                          <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable" align='center'>
                                              ...
                                              <p style='color:#222222;'>{{$data->receiver_name}}</p>
                                              <p style='color:#222222;'>Mae Fah Luang University</h2>
                                              <p style='color:#222222;'>333 Moo1, Thasud, Muang, Chiang Rai 57100</p>
                                            </div>
                                          </div>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td align='left'>
                                          <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable" align='center'>
                                              <p style='color:#222222;'>Dear {{$data->receiver_name}},</p>
                                            </div>
                                          </div>
                                        </td>
                                      </tr>
                                          ...
                                          <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable" align='center'>
                                              <p style='color:#222222;'>
                                                ...
                                                <br>
                                                <br>
                                                I need to make an appointment with you on {{$data->time}} at {{$data->appointment_room}}. If you have no other appointment at that time. Could you please make a decision of this appointment. If you want to contact me directly. Reply me with {{$data->sender_email}}
                                                <br>
                                                <br>
                                      ...
                                      <tr>
                                        <td align='center'>
                                          <table>
                                            <tr>
                                              <td align='center' bgcolor='#00ff00' style='background:#00ff00; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                <div class="contentEditableContainer contentTextEditable">
                                                  <div class="contentEditable" align='center'>
                                                    <a target='_blank' href='http://127.0.0.1:8000/appointment/{{$data->token}}/accept' class='link2' style='color:#ffffff;'>Accept</a>
                                                  </div>
                                                </div>
                                              </td>
                                            </tr>
                                            ...
                                            <tr>
                                              <td align='center' bgcolor='#ff0000' style='background:#ff0000; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                <div class="contentEditableContainer contentTextEditable">
                                                  <div class="contentEditable" align='center'>
                                                    <a target='_blank' href="http://127.0.0.1:8000/appointment/{{$data->token}}/reject" class='link2' style='color:#ffffff;'>Reject</a>
                                                  </div>
                                                </div>
                                              </td>
                                            </tr>
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                      <div class="contentEditable" align='center'>
                                                        <p style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                          <span style='font-weight:bold;'>Mae Fah Luang University</span>
                                                          <br>
